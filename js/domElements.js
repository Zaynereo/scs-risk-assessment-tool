export class DOMElements {
    constructor() {
        ...
        this.landing = { assessmentCards: document.querySelectorAll('.assessment-card'), cardButtons: document.querySelectorAll('.card-btn') };
        this.onboarding = {
        ...
        this.results = { riskLevel: document.getElementById('results-risk-level'), summary: document.getElementById('results-summary'), scoreNumber: document.getElementById('score-number'), scoreArc: document.getElementById('score-arc'), breakdownContainer: document.getElementById('breakdown-categories'), recommendationsContainer: document.getElementById('recommendations-container'), playAgainBtn: document.getElementById('play-again-btn') };
        this.mascot = { img: document.getElementById('mascot-img'), liveContainer: document.getElementById('live-mascot-container') };
    }
    switchScreen(name) { Object.values(this.screens).forEach(s => s?.classList.remove('active')); this.screens[name]?.classList.add('active'); }
